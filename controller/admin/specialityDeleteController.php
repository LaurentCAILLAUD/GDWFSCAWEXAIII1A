...
if (!isset($_SESSION['userEmail']) || $_SESSION['userRole'] != 'ROLE_ADMIN') {
    ...
    try {
        ...
        if (isset($_GET['confirm'])) {
            ...
            if ($_GET['confirm'] == 'yes') {
                // Afin de supprimer ma spécialité je vais avoir besoin de me connecter à la base de données. Etant donné que je souhaite que mon application tourne en production ou en local, j'utilise cette condition:
