...
if (!isset($_SESSION['userEmail']) || $_SESSION['userRole'] != 'ROLE_ADMIN') {
    ...
    try {
        ...
        // Pour cela je vais avoir besoin de me connecter à ma base de données. Ettanr donné que je souhaite faire tourner mon application en production ou en local j'uilise la condition si dessous:
