...
if (!isset($_SESSION['userEmail']) || $_SESSION['userRole'] != 'ROLE_ADMIN') {
    ...
    try {
        // Le but de ce contrôleur est de récupérer les spécialités enregistrées dans la base de données. Pour cela, il va fallor que je me connecte à la base de données et il me faut donc dasn un premier temps créé mon Data Source Name:
