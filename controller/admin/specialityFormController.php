        ...
        if (isset($_POST['specialityFormSubmit'])) {
            ...
            if (!empty($_POST['specialityWritten'])) {
                ...
                if (strlen($specialityWrittenFormated) <= 50) {
                    ...
                    // Ceci fait, je vais maintenant pouvoir enregistrer cette spécialité (avec son id) dans la base de données. Pour ce faire, il faut tout d'abord que je me connecte à la base de données. Etant donné que je souhaite que mon application tourne en production ou en local, j'utilise cette condition:
