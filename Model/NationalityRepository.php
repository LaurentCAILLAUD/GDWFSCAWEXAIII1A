...
class NationalityRepository
{
    ...
    // Fonction qui va me permettre de supprimer une nationalité grâce à son id:
    public function deleteThisNationalityWithThisId(string $id): void
    {
        // Je prépare ma requête:
        $stmt = $this->db->prepare('DELETE FROM nationality WHERE id = :id');
        // Je lie mes données:
        $stmt->bindValue(':id', $id);
