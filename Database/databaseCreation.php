                ...
                if ($db->exec('CREATE TABLE IF NOT EXISTS mission_type (id CHAR(36) NOT NULL PRIMARY KEY, name VARCHAR(50) NOT NULL)') !== false) {
                    ...
                    if ($db->exec('CREATE TABLE IF NOT EXISTS mission_status (id CHAR(36) NOT NULL PRIMARY KEY, name VARCHAR(50) NOT NULL)') !== false) {
                        ...
                        if ($db->exec('CREATE TABLE IF NOT EXISTS nationality_country (id CHAR (36) NOT NULL PRIMARY KEY, name VARCHAR(50) NOT NULL, country VARCHAR(50) NOT NULL)') !== false) {
                            ...
                            if ($db->exec('CREATE TABLE IF NOT EXISTS mission (id CHAR(36) NOT NULL PRIMARY KEY, title VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, code_name VARCHAR(100) NOT NULL, mission_start DATETIME NOT NULL, mission_end DATETIME NOT NULL, nationality_country_id CHAR(36) NOT NULL, specialtity_id CHAR(36) NOT NULL, mission_type_id CHAR(36) NOT NULL, mission_status_id CHAR(36) NOT NULL, FOREIGN KEY (nationality_country_id) REFERENCES nationality_country(id) ON DELETE CASCADE, FOREIGN KEY (specialtity_id) REFERENCES speciality(id) ON DELETE CASCADE, FOREIGN KEY (mission_type_id) REFERENCES mission_type(id) ON DELETE CASCADE, FOREIGN KEY (mission_status_id) REFERENCES mission_status(id) ON DELETE CASCADE)') !== false) {
